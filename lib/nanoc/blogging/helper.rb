...
module Nanoc::Blogging
  ...
  module Helper
    ...
    protected
      ...
      def build_for_feed(xml)
        ...
        xml.feed(:xmlns => 'http://www.w3.org/2005/Atom') do
          ...
          # Add date
          updated_time = attribute_to_time(last_article[:created_at])
          xml.updated(to_iso8601_time(updated_time))
      ...
      def build_for_article(a, xml)
        ...
        xml.entry do
          ...
          # Add dates
          xml.published to_iso8601_time(attribute_to_time(a[:created_at]))
          xml.updated   to_iso8601_time(attribute_to_time(a[:updated_at] || a[:created_at]))
    ...
    def atom_tag_for(item)
      ...
      formatted_date = to_iso8601_date(time)
